...
as well as support for subclass propagation (e.g. event assigned to
...
class _ClsLevelDispatch(RefCollection):
    """Class-level event on :class:`._Dispatch` classes."""
...
class _EmptyListener(_InstanceLevelDispatch):
    """Serves as a proxy interface to the event
    served by a _ClsLevelDispatch, when there are no
    instance-level event present.
