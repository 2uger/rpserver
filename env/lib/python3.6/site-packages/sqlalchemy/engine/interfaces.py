...
class Dialect(object):
    ...
    def on_connect(self):
        ...
        callable.  The reason it is invoked for both event is so that any
    ...
    def engine_created(cls, engine):
        ...
        event to the engine or its components.   In particular, it allows
        a dialect-wrapping class to apply dialect-level event.
...
class CreateEnginePlugin(object):
    ...
    * connection and SQL performance tools, e.g. which use event to track
    ...
    * connectivity plugins such as proxies
    ...
    event (e.g. those defined in :ref:`core_event_toplevel`).
    ...
    def engine_created(self, engine):
        ...
        registering engine or connection pool event.
