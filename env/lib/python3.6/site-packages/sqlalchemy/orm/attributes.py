...
class QueryableAttribute(
    ...
    attribute event on behalf of a :class:`.MapperProperty`
...
class Event(object):
    ...
    when dealing with event such as :meth:`.AttributeEvents.append`,
    ...
    def __init__(
        ...
        **kwargs
        ...
        :param extension:
          ...
          receive set/delete/append/remove/etc. event.
...
class ScalarObjectAttributeImpl(ScalarAttributeImpl):
    """represents a scalar-holding InstrumentedAttribute,
       ...
       Adds event to delete/set operations.
...
def set_committed_value(instance, key, value):
    """Set the value of an attribute with no history event.
...
def set_attribute(instance, key, value, initiator=None):
    """Set the value of an attribute, firing history event.
...
def del_attribute(instance, key):
    """Delete the value of an attribute, firing history event.
...
def flag_dirty(instance):
    ...
    the flush process for interception by event such as
