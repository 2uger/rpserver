...
class ClassManager(dict):
    ...
    def __init__(self, class_):
        ...
        # event._InstanceEventsHold.populate(class_, self)
...
class _SerializeManager(object):
    ...
    def __call__(self, state, inst, state_dict):
        ...
        # unpickle event can access the object normally.
        # see [ticket:2362]
        if inst is not None:
...
def _generate_init(class_, class_manager):
    """Build an __init__ decorator that triggers ClassManager event."""
