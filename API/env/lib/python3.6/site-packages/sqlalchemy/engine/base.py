    ...
    def __init__(
        ...
        if _branch_from:
            ...
            if _has_events is None:
                ...
                # want to handle any of the engine's event in that case.
...
class Engine(Connectable, log.Identified):
    ...
    def execution_options(self, **opt):
        ...
        * Event listeners are "cascaded" - meaning, the new
          :class:`_engine.Engine`
          inherits the event of the parent, and new event can be associated
...
class OptionEngine(Engine):
    ...
    def __init__(self, proxied, execution_options):
        ...
        # note: this will propagate event that are assigned to the parent
        # engine after this OptionEngine is created.   Since we share
        # the event of the parent we also disallow class-level event
        ...
        # change for logic that assigns event to the parent engine and
