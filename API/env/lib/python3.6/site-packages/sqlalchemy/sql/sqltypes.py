...
class SchemaType(SchemaEventTarget):
    ...
    :meth:`.DDLEvents.after_parent_attach` event, where the event fire off
...
class PickleType(TypeDecorator):
    ...
    To allow ORM change event to propagate for elements associated
...
class JSON(Indexable, TypeEngine):
    ...
    **Detecting Changes in JSON columns when using the ORM**
    ...
    allow "in-place" changes to the datastructure to produce event which
