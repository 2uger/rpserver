...
class DDLElement(Executable, _DDLCompiles):
    ...
    :class:`.DDLElement` integrates closely with SQLAlchemy event,
    ...
    def execute_at(self, event_name, target):
        ...
        :param event:
          One of the event defined in the schema item's ``.ddl_events``;
...
class DDL(DDLElement):
    ...
    function as DDL event listeners, and can be subscribed to those event
    ...
    When operating on Table event, the following ``statement``
