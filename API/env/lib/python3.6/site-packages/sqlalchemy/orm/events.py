...
class InstrumentationEvents(event.Events):
    """Events related to class instrumentation event.

    The listeners here support being established against
    any new style class, that is any object that is a subclass
    of 'type'.  Events will then be fired off for event
    against that class.  If the "propagate=True" flag is passed
    to event.listen(), the event will fire off for subclasses
    of that class as well.

    The Python ``type`` builtin is also accepted as a target,
    which when used has the effect of event being emitted
    for all classes.

    Note the "propagate" flag here is defaulted to ``True``,
    unlike the other class level event where it defaults
    to ``False``.  This means that new subclasses will also
    be the subject of these event, when a listener
...
class InstanceEvents(event.Events):
    """Define event specific to object lifecycle.
    ...
    * the :class:`_orm.Mapper` class itself and the :func:`.mapper`
    ...
    Instance event are closely related to mapper event, but
    ...
    :param restore_load_context=False: Applies to the
       ...
       event.  Restores the loader context of the object when the event
        ...
        .. warning::
            ...
            * accessing attributes on a joined-inheritance subclass that
            ...
            .. versionchanged:: 1.3.14 Added
               ...
               apply to "on load" event, which will ensure that the loading
...
class MapperEvents(event.Events):
    """Define event specific to mappings.
    ...
    * the :class:`_orm.Mapper` class itself and the :func:`.mapper`
    ...
    Mapper event provide hooks into critical sections of the
    ...
    def _listen(
        ...
        if (
            ...
            util.warn(
                "'before_configured' and 'after_configured' ORM event "
    ...
    def before_mapper_configured(self, mapper, class_):
        ...
        In comparison to the other configure-level event,
    ...
    def before_insert(self, mapper, connection, target):
        ...
        .. warning::
            ...
            Mapper-level flush event only allow **very limited operations**,
...
class SessionEvents(event.Events):
    """Define event specific to :class:`.Session` lifecycle.
    ...
    def before_commit(self, session):
        ...
        .. note::
            ...
            For interception of these event, use the
    ...
    def loaded_as_persistent(self, session, instance):
        ...
        with the other session lifecycle event smoothly.  The object
    ...
    def deleted_to_detached(self, session, instance):
        ...
        event are called, as well as if the object is individually
...
class AttributeEvents(event.Events):
    r"""Define event for object attributes.
    ...
    def bulk_replace(self, target, values, initiator):
        ...
        event, note that a bulk replace operation will invoke
    ...
    def init_scalar(self, target, value, dict_):
        ...
        * The ``propagate=True`` flag is significant if the mapped class
        ...
        value to the given ``dict_``.  To have these event to invoke in
        ...
        object as a normal attribute set operation::
            ...
            @event.listens_for(
                ...
                retval=True, propagate=True)
            def _init_some_attribute(target, dict_, value):
                # will also fire off attribute set event
    ...
    def init_collection(self, target, collection, collection_adapter):
        ...
        .. versionadded:: 1.0.0 the :meth:`.AttributeEvents.init_collection`
           and :meth:`.AttributeEvents.dispose_collection` event supersede
...
class QueryEvents(event.Events):
    """Represent event within the construction of a :class:`_query.Query`
    object.

    The event here are intended to be used with an as-yet-unreleased
