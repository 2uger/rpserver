...
class Session(_SessionClassMethods):
    ...
    def __init__(
        ...
        :param extension: An optional
           ...
           flush event, as well as a post-rollback event.
    ...
    def merge(self, instance, load=True):
        ...
        :param load: Boolean, when False, :meth:`.merge` switches into
         ...
         event as well as all database access.  This flag is used for
         ...
         event, and without the need to reconcile the incoming data with
    ...
    def _flush(self, objects=None):
        ...
        try:
            ...
            if not objects and self.identity_map._modified:
                ...
                util.warn(
                    "Attribute history event accumulated on %d "
    ...
    def is_modified(self, instance, include_collections=True, passive=None):
        ...
        * Instances present in the :attr:`.Session.dirty` collection may
          ...
          the object may have received change event via attribute mutation,
    ...
    def is_active(self):
        ...
        :meth:`.SessionEvents.after_commit`,
        :meth:`.SessionEvents.after_rollback` and related event.
...
class sessionmaker(_SessionClassMethods):
    ...
    def __init__(
        ...
        **kw
        ...
        # event can be associated with it specifically.
